...
public class AStarTree {
    ...
    private SearchNode pickBestPos(ArrayList<SearchNode> posPool) {
        ...
        for (SearchNode current : posPool) {
            ...
            float currentCost = - 10000 * current.getCollectRate() - 5000* current.ifWin() + 100000 * current.ifLose();
            if (current.sceneSnapshot.getMarioFloatPos()[0] - currentSearchStartingMarioXPos > maxRight + 10)
