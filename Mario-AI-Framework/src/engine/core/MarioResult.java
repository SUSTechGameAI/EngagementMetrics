...
public class MarioResult {
    ...
    private ArrayList<Float> MarioPos;
     ...
     */
    public MarioResult(MarioWorld world, ArrayList<MarioEvent> gameEvents, ArrayList<MarioAgentEvent> agentEvents, int TotalState, int LoseState, ArrayList<Float> MarioPos) {
        this.world = world;
        this.gameEvents = gameEvents;
        this.agentEvents = agentEvents;
        System.out.println(TotalState + " " + LoseState);
    ...
    public ArrayList<Float> getMarioPos(){
        return this.MarioPos;
    }
    ...
    public double getFailRate() {
        return (double) this.getLoseState()/this.getTotalState();
    }

    public void printAgentEvent() {
        for (MarioAgentEvent event : this.agentEvents) {
            System.out.println(Arrays.toString(event.getActions()));
            System.out.println(event.getMarioX() + " " + event.getMarioY());
        }
    }

    public void printGameEvent() {
        for (MarioEvent event : this.gameEvents) {
            System.out.println(event.getEventType() + " " + event.getMarioX() + " " + event.getMarioY());
        }
    }
}
