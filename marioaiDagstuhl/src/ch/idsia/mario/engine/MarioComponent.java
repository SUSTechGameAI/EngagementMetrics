...
//=========
        if (agent instanceof AgentWithBehavior) {
            Behavior behavior = ((AgentWithBehavior) agent).getBehavior();
            evaluationInfo.marioDeathStates = behavior.getDeathStates();
            evaluationInfo.marioTotalStates = behavior.getTotalStates();
            ((AgentWithBehavior) agent).clearBehavior();
        }
